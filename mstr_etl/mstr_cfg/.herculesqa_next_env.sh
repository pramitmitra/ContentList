...
export HADOOP_HOME=/apache/hadoop_client/herculesqa_next/hadoop
#export HADOOP_HOME2=/apache/hadoop_client/${STORAGE_ENV}/hadoop
export HADOOP_HOME2=/apache/hadoop_client/herculesqa_next/hadoop
export HIVE_HOME=/apache/hadoop_client/herculesqa_next/hive
#export SPARK_HOME=/apache/hadoop_client/${COMPUTE_ENV}/spark
export SPARK_HOME=/apache/hadoop_client/herculesqa_next/spark
