...
export HADOOP_HOME=/apache/hadoop_client/olympus/hadoop
export HADOOP_HOME2=/apache/hadoop_client/${STORAGE_ENV}/hadoop
export HIVE_HOME=/apache/hadoop_client/olympus/hive
...
#export TEZ_HOME=/apache/hadoop_client/olympus/tez
...
export HADOOP_HISTORY_LOG="https://olympus-lvs-rm-1.vip.ebay.com:50030/cluster/apps/FINISHED"
