#############
# this section contains exports ONLY for juno
#############
export ORIGPATH=$PATH
export MANPATH=$MANPATH:/usr/share/man:/usr/local/man:/usr/local/pssh:/usr/local/pssh/man
export EDITOR=vi
export PS1="[\$(date +%H:%M)]:[\u@\h:\W]\$ "
export HBASE_HOME=/apache/hadoop_client/juno/hbase
export HADOOP_HOME=/apache/hadoop_client/juno/hadoop
export HADOOP_HOME2=$HADOOP_HOME
export HIVE_HOME=/apache/hadoop_client/juno/hive
export HADOOP_CONF_DIR=$HADOOP_HOME/conf
export HIVE_CONF_DIR=$HIVE_HOME/conf
export HADOOP_PID_DIR=$HADOOP_HOME/pids
export HADOOP_LOG_DIR=$HADOOP_HOME/logs
export TEZ_HOME=/apache/hadoop_client/juno/tez
...
export HADOOP_NN_URL=$HD5_NN_URL
export HADOOP_CLI_HOST="lvshshdc2en0008.lvs.ebay.com"
