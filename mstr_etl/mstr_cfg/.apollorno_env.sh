#############
# this section contains exports ONLY for apollorno
#############
...
export SPARK_HOME=/apache/hadoop_client/apollorno/spark
export HBASE_HOME=/apache/hadoop_client/apollorno/hbase
export HADOOP_HOME=/apache/hadoop_client/apollorno/hadoop
export HADOOP_HOME2=$HADOOP_HOME
export HIVE_HOME=/apache/hadoop_client/apollorno/hive
