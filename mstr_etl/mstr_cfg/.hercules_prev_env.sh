#############
# this section contains exports ONLY for Hercules
#############
...
export HADOOP_HOME=/apache/hadoop_client/hercules_prev/hadoop
#export HADOOP_HOME2=/apache/hadoop_client/${STORAGE_ENV}/hadoop
export HADOOP_HOME2=/apache/hadoop_client/hercules_prev/hadoop
export HIVE_HOME=/apache/hadoop_client/hercules_prev/hive
#export SPARK_HOME=/apache/hadoop_client/${COMPUTE_ENV}/spark
export SPARK_HOME=/apache/hadoop_client/hercules_prev/spark
export PARTITION_NAME=dt
export HADOOP_CONF_DIR=$HADOOP_HOME2/conf
export HIVE_CONF_DIR=$HIVE_HOME/conf
#export HADOOP_PID_DIR=$HADOOP_HOME/pids
#export HADOOP_LOG_DIR=$HADOOP_HOME/logs
#export TEZ_HOME=/apache/hadoop_client/hercules_prev/tez
...
export HADOOP_HISTORY_LOG="http://hdc34-lvs01-620-1404-003.lvs02.eaz.ebayc3.com:50070/cluster/apps/FINISHED"
