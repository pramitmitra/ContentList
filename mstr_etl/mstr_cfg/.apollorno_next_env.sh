...
export SPARK_HOME=/apache/hadoop_client/apollorno_next/spark
export HBASE_HOME=/apache/hadoop_client/apollorno_next/hbase
export HADOOP_HOME=/apache/hadoop_client/apollorno_next/hadoop
export HADOOP_HOME2=$HADOOP_HOME
export HIVE_HOME=/apache/hadoop_client/apollorno_next/hive
