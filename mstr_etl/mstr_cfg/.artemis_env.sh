#############
# this section contains exports ONLY for artemis
#############
export ORIGPATH=$PATH
export MANPATH=$MANPATH:/usr/share/man:/usr/local/man:/usr/local/pssh:/usr/local/pssh/man
export EDITOR=vi
export PS1="[\$(date +%H:%M)]:[\u@\h:\W]\$ "
export HBASE_HOME=/apache/hadoop_client/artemis/hbase
export HADOOP_HOME=/apache/hadoop_client/artemis/hadoop
export HADOOP_HOME2=$HADOOP_HOME
export HIVE_HOME=/apache/hadoop_client/artemis/hive
