#############
# this section contains exports ONLY for Hercules RNO
#############
...
export HADOOP_HOME=/apache/hadoop_client/herculesrno_next/hadoop
export HADOOP_HOME2=/apache/hadoop_client/herculesrno_next/hadoop
export HIVE_HOME=/apache/hadoop_client/herculesrno_next/hive
export SPARK_HOME=/apache/hadoop_client/herculesrno_next/spark
export PARTITION_NAME=dt
export HADOOP_CONF_DIR=$HADOOP_HOME2/conf
export HIVE_CONF_DIR=$HIVE_HOME/conf
#export HADOOP_PID_DIR=$HADOOP_HOME/pids
#export HADOOP_LOG_DIR=$HADOOP_HOME/logs
#export TEZ_HOME=/apache/hadoop_client/herculesrno_next/tez
