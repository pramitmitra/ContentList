#!/bin/ksh -eu
#------------------------------------------------------------------------------------------------
# Filename:     dw_infra.loader_cleanup_tpt.ksh
# Description:  Handler to call dw_infra.loader_cleanup remotely for TPT
#
# Developer:    Ryan Wong
# Created on:   2012-11-11
# Location:     $DW_MASTER_BIN/
#
# Execution:    $DW_MASTER_BIN/dw_infra.loader_cleanup_tpt.ksh <ETL_ID> <JOB_ENV> <JOB_TYPE_ID> [[ -b <MIN_LOAD_BATCH_SEQ_NUM> ] or [ -f <UOW_FROM> -t <UOW_TO> ]]
#
# Revision History:
#
...
function usage_tpt {
   print "Usage:  $0 <ETL_ID> <JOB_ENV> <JOB_TYPE_ID> [[ -b <MIN_LOAD_BATCH_SEQ_NUM> ] or [ -f <UOW_FROM> -t <UOW_TO> ]]
...
do
   case $opt in
      ...
      t ) if [ $UOW_TO_FLAG -ne 0 ]
          ...
          UOW_TO=$OPTARG;;
      b ) if [ $MIN_LOAD_BATCH_SEQ_NUM -ne 0 ]
          then
