...
###################################################################################################################
#
# Title:        DW_INFRA Create Infrastructure Multi File Systems  
# File Name:    dw_infra.create_infra_mfs_rh.ksh 
# Description:  Script to create standard infrastructure multi file systems on Ab Initio platforms 
...
#---------    -----  ---------------------------  ------------------------------
# 2012-09-01   1.0    Kevin Oaks                    Ported to RedHat from original dw_infra.create_infra_mfs.ksh:
