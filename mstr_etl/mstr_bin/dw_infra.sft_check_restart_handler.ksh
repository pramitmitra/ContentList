...
###################################################################################################################
#
# Title:        SFT Check Restart Handler
# File Name:    sft_check_restart_handler.ksh
# Description:  Handler for Check Restart Socpart Server
# Developer:    Ryan Wong
...
then
   ...
   set +e
   (time $DW_MASTER_BIN/dw_infra.sft_check_restart_run.ksh) > $PARENT_LOG_FILE 2>&1
   RUN_RCODE=$?
...
print "Socparc Server Check Complete" `date`
