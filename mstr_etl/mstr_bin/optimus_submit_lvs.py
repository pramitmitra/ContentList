...
def submit(src, dst):
    ...
    submit_url = '''curl -s -k --negotiate -u : -H "Content-Type: application/json" -X POST -d '{0}' https://bdp.vip.ebay.com/optimus-lvs/job'''
...
def getStatus(jobid):
    query_url = '''curl -s -k --negotiate -u : -H "Content-Type: application/json" -X GET https://bdp.vip.ebay.com/optimus-lvs/job/{0}'''
